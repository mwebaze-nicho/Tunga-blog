    ...
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-2 grid max-w-2xl grid-cols-1 gap-8 border-t border-gray-200 pt-4 lg:mx-0 lg:max-w-none lg:grid-cols-3 ">
            {isLoading ? (
              <LoadingFrame />
            ) : error ? (
              ...
              filteredData.map((post, index) => {
                ...
                return (
                  <article
                    key={index}
                    className="flex max-w-xl flex-col items-start justify-between shadow-lg px-4 mb-6 bg-white rounded-lg overflow-hidden"
                  >
                    ...
                    <div>
                      <div className="flex items-center gap-x-4 text-xs mt-4 px-4">
                      ...
                      <div className="relative mt-4 mb-6 flex items-center gap-x-4 px-4">
                        <Image
                          src="/person.jpeg"
                          alt="author"
                          width={96}
                        ...
                        <div className="text-sm leading-6">
                          <p className="text-gray-500">{post.postCreator}</p>
                        </div>
                      </div>
                    </div>
                  </article>
